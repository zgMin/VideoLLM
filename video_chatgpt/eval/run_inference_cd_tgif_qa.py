...
def run_inference(args):
    ...
    gt_qas = []
    # 打开CSV文件
    with open(args.gt_file_qa, 'r', encoding='utf-8') as csvfile:
    ...
    for sample in tqdm(gt_qas):
        ...
        try:
            ...
            output = video_chatgpt_infer_cd(video_frames, video_features, question, conv_mode, model, vision_tower,
