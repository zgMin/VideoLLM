...
def run_inference(args):
    ...
    for sample in tqdm(gt_contents):
        ...
        try:
            ...
            output_1 = video_chatgpt_infer(video_frames, video_features, question_1, conv_mode, model, vision_tower,
            ...
            output_2 = video_chatgpt_infer(video_frames, video_features, question_2, conv_mode, model, vision_tower,
                                             tokenizer, image_processor, video_token_len)
