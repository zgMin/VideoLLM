from video_chatgpt.eval.init_skip_attention import replace_llama_attn_with_skip_attn_for_cd
replace_llama_attn_with_skip_attn_for_cd()
import os
import pickle
import torch
...
from video_chatgpt.inference import video_chatgpt_infer_cd
...
def run_inference(args):
    ...
    for sample in tqdm(gt_contents):
        ...
        try:
            ...
            output_1 = video_chatgpt_infer_cd(video_frames, video_features, question_1, conv_mode, model, vision_tower,
            ...
            output_2 = video_chatgpt_infer_cd(video_frames, video_features, question_2, conv_mode, model, vision_tower,
                                             tokenizer, image_processor, video_token_len)
